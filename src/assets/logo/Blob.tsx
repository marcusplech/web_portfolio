import logo from '@/assets/imgs/coding.webp';
  ...
  >
    <defs>
      <linearGradient id="blobGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="hsl(var(--hue-color) 72% 56%)" />
        <stop offset="100%" stopColor="hsl(var(--hue-color) 65% 48%)" />
      </linearGradient>
    </defs>
    <g mask="url(#mask0)">
      <path
      ...
      />
      <image className="home__blob_img" href={logo.src} x="27" y="15" />
    </g>
  </svg>
);
